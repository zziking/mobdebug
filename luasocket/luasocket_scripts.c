...
//    {"socket.core", luaopen_socket_core},//君展add core for ios
    {"socket", luaopen_lua_m_socket},
    
    {NULL, NULL}
};

static void register_luasocket_core(lua_State *L)
{
    luaL_Reg luax_exts[] = {
